...
mixin _$NewsState {
 ...
 NewsFeedType get activeFeed; Map<NewsFeedType, List<Article>> get feedArticles; Map<NewsFeedType, int> get feedPages; Map<NewsFeedType, bool> get feedHasMore; List<Article> get bookmarks; bool get isLoading; bool get isRefreshing; bool get isLoadingMore; bool get isOffline; bool get hasError; String get errorMessage;
...
@useResult
$Res call({
 NewsFeedType activeFeed, Map<NewsFeedType, List<Article>> feedArticles, Map<NewsFeedType, int> feedPages, Map<NewsFeedType, bool> feedHasMore, List<Article> bookmarks, bool isLoading, bool isRefreshing, bool isLoadingMore, bool isOffline, bool hasError, String errorMessage
});
...
as Map<NewsFeedType, List<Article>>,feedPages: null == feedPages ? _self.feedPages : feedPages // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( NewsFeedType activeFeed,  Map<NewsFeedType, List<Article>> feedArticles,  Map<NewsFeedType, int> feedPages,  Map<NewsFeedType, bool> feedHasMore,  List<Article> bookmarks,  bool isLoading,  bool isRefreshing,  bool isLoadingMore,  bool isOffline,  bool hasError,  String errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NewsState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( NewsFeedType activeFeed,  Map<NewsFeedType, List<Article>> feedArticles,  Map<NewsFeedType, int> feedPages,  Map<NewsFeedType, bool> feedHasMore,  List<Article> bookmarks,  bool isLoading,  bool isRefreshing,  bool isLoadingMore,  bool isOffline,  bool hasError,  String errorMessage)  $default,) {final _that = this;
switch (_that) {
case _NewsState():
return $default(_that.activeFeed,_that.feedArticles,_that.feedPages,_that.feedHasMore,_that.bookmarks,_that.isLoading,_that.isRefreshing,_that.isLoadingMore,_that.isOffline,_that.hasError,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( NewsFeedType activeFeed,  Map<NewsFeedType, List<Article>> feedArticles,  Map<NewsFeedType, int> feedPages,  Map<NewsFeedType, bool> feedHasMore,  List<Article> bookmarks,  bool isLoading,  bool isRefreshing,  bool isLoadingMore,  bool isOffline,  bool hasError,  String errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _NewsState() when $default != null:
return $default(_that.activeFeed,_that.feedArticles,_that.feedPages,_that.feedHasMore,_that.bookmarks,_that.isLoading,_that.isRefreshing,_that.isLoadingMore,_that.isOffline,_that.hasError,_that.errorMessage);case _:
  return null;
...
class _NewsState implements NewsState {
  const _NewsState({this.activeFeed = NewsFeedType.topHeadlines, final  Map<NewsFeedType, List<Article>> feedArticles = const <NewsFeedType, List<Article>>{}, final  Map<NewsFeedType, int> feedPages = const <NewsFeedType, int>{}, final  Map<NewsFeedType, bool> feedHasMore = const <NewsFeedType, bool>{}, final  List<Article> bookmarks = const [], this.isLoading = false, this.isRefreshing = false, this.isLoadingMore = false, this.isOffline = false, this.hasError = false, this.errorMessage = ''}): _feedArticles = feedArticles,_feedPages = feedPages,_feedHasMore = feedHasMore,_bookmarks = bookmarks;
  

@override@JsonKey() final  NewsFeedType activeFeed;
 final  Map<NewsFeedType, List<Article>> _feedArticles;
@override@JsonKey() Map<NewsFeedType, List<Article>> get feedArticles {
...
@override@JsonKey() List<Article> get bookmarks {
...
as Map<NewsFeedType, List<Article>>,feedPages: null == feedPages ? _self._feedPages : feedPages // ignore: cast_nullable_to_non_nullable
